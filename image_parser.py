...
parser.add_argument('-u', '--base_url', type=str, required=True, help='The base URL of the website to search.')
parser.add_argument('-s', '--start_page', type=int, required=True, help='The number of the starting page.')
parser.add_argument('-e', '--end_page', type=int, required=True, help='The number of the ending page.')
parser.add_argument('-o', '--output_file', type=str, default='broken_images.txt', help='The path to the output file.')
